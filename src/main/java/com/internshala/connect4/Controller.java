...
public class Controller implements Initializable {
        ...
        for(int col = 0 ; col < COLUMNS ; col++) {
            ...
            rectangle.setOnMouseClicked(event -> {
                if(isAllowedToInsert) {
                    isAllowedToInsert = false; // To stop multiple consecutive insertion of discs from same player
    ...
    private void insertDisc(Disc disc, int column){
        ...
        TranslateTransition translate = new TranslateTransition(Duration.seconds(0.5), disc);
        translate.setToY(row * (CIRCLE_DIAMETER + 5) + CIRCLE_DIAMETER / 4);
        ...
        translate.setOnFinished(event -> {
            ...
            if(totalDiscsEntered == ROWS * COLUMNS){ // In case the playground is completely filled and no player has won
                gameDrawn();
                return;
            }
    ...
    private void gameDrawn() {
        ...
        alert.setHeaderText("The game is drawn");
        ...
        Platform.runLater(()->{ // To make sure that the code below is executed after completion of insertion animation
    ...
    private boolean checkCombinations(List<Point2D> points2D) {
